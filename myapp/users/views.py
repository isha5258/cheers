...
from myapp.models import User, BreweryPost
...
def user_posts(username):
    ...
    brewery_posts = BreweryPost.query.filter_by(author=user).order_by(BreweryPost.date.desc()).paginate(page=page, per_page=5) 
